        ...
        <section id="projeler">
          ...
          <div className="project-grid">
            <article className="project-card">
              <div className="project-sample">TrendSepetix</div>
              <h3>TrendSepetix</h3>
              <p>Alışveriş sepeti verilerini analiz ederek kullanıcı davranışlarını raporlayan sistem.</p>
              <p><strong>Teknolojiler:</strong> Python, React, MySQL</p>
              <figcaption>E-ticaret veri analitiği görseli</figcaption>
            </article>

            <article className="project-card">
              <div className="project-sample">Web Lab 1</div>
              <h3>Web Lab 1</h3>
              <p>Temel web teknolojileri ve sürüm kontrol sistemleri üzerine yapılan başlangıç çalışması.</p>
              <p><strong>Teknolojiler:</strong> HTML, CSS, JavaScript, Vite</p>
              <figcaption>Laboratuvar çalışması arayüzü</figcaption>
            </article>
          </div>
        </section>
